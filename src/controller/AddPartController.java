...
/**
 * Controller class that provides logic for the application's add part screen.
 *
 *
 */
public class AddPartController implements Initializable {
    ...
    /**
     * Validates that inventory level is equal to or between min and max.
     *
     * @param min The minimum value for the part.
     * @param max The maximum value for the part.
     * @param stock The inventory level for the part.
     * @return Boolean showing if inventory is valid.
     */
